...
class Cart(models.Model):
    ...
    user = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE) #relacion con user uno a muchos
    products = models.ManyToManyField(Product, through='CartProducts')      #relacion muchos a muchos
    subtotal = models.DecimalField(default=0.0, max_digits=8, decimal_places=2)
    total = models.DecimalField(default=0.0, max_digits=8, decimal_places=2)
    created_ad = models.DateTimeField(auto_now_add=True)

    FEE = 0.05 #0.5% impuestos
